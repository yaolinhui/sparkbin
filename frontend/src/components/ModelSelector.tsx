  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-2 px-3 py-2 border border-brutal-border hover:border-brutal-text hover:bg-brutal-surface-hover transition-colors ${className}`}
